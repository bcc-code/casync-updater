...
echo ''
echo -e "${NC}"
casync extract --with=2sec-time --store=https://bcc-code.github.io/casync-updater/master/store.castr https://bcc-code.github.io/casync-updater/master/index.caidx /opt/casync-updater/
